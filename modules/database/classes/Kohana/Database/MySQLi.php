...
//		{
			...
			if ($persistent)
			{
				...
				$this->_connection->real_connect('p:'.$hostname, $username, $password, $database, $port, $socket, $flags);
			}
			else
			{
				// Create a connection and force it to be a new link
				$this->_connection->real_connect($hostname, $username, $password, $database, $port, $socket,$flags);
			}
//		}
...
//				array(':error' => $_connection->connect_error,),
//				$_connection->connect_errno);
//		}
	...
	public function disconnect()
	{
		...
		catch (Exception $e)
		{
			...
			$status = ! is_resource($this->_connection instanceof MySQLi);
		}
